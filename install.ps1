...
#
# Pin a version:
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/la2278647-arch/ctxpack/main/install.ps1))) 'v0.1.6'
#
# Environment:
...
.PARAMETER Version
    Optional version tag to install (e.g. v0.1.6). Defaults to the latest.
#>
